...
namespace ShadowrunGM.API.Infrastructure.Migrations
{
    ...
    [Migration("20250830221748_AddCharactersTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShadowrunGM.Domain.Character.Character", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("ix_characters_created_at");

                    b.HasIndex("ModifiedAt")
                        .HasDatabaseName("ix_characters_modified_at");
            ...
            modelBuilder.Entity("ShadowrunGM.Domain.Character.Character", b =>
                {
                    b.OwnsOne("ShadowrunGM.Domain.Character.ValueObjects.AttributeSet", "Attributes", b1 =>
                        {
                            ...
                            b1.Property<int>("Intuition")
                                .HasColumnType("integer")
                                .HasColumnName("Intuition");

                            b1.Property<int>("Logic")
                                .HasColumnType("integer")
                                .HasColumnName("Logic");
                    ...
                    b.OwnsOne("ShadowrunGM.Domain.Character.ValueObjects.ConditionMonitor", "Health", b1 =>
                        {
                            b1.Property<Guid>("CharacterId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");

                            b1.Property<int>("PhysicalBoxes")
                                .HasColumnType("integer")
                                .HasColumnName("PhysicalBoxes");

                            b1.Property<int>("PhysicalDamage")
                                .HasColumnType("integer")
                                .HasColumnName("PhysicalDamage");

                            b1.Property<int>("StunBoxes")
                                .HasColumnType("integer")
                                .HasColumnName("StunBoxes");

                            b1.Property<int>("StunDamage")
                                .HasColumnType("integer")
                                .HasColumnName("StunDamage");
                    ...
                    b.OwnsOne("ShadowrunGM.Domain.Character.ValueObjects.Edge", "Edge", b1 =>
                        {
                            b1.Property<Guid>("CharacterId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                            ...
                            b1.Property<int>("Current")
                                .HasColumnType("integer")
                                .HasColumnName("CurrentEdge");

                            b1.Property<int>("Max")
                                .HasColumnType("integer")
                                .HasColumnName("MaxEdge");
